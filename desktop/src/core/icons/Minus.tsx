...
export default function Minus(props:IconProps) {
  ...
  return (
    <svg width="800px" height="800px" viewBox="0 -12 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" {...extra}>
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
        <g id="Icon-Set-Filled" transform="translate(-414.000000, -1049.000000)" fill={color ||"#000000"}>
